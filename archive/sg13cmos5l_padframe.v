...
`endif	/* USE_POWER_PINS */
    ...
    inout wire s1_an_2_esd,
    inout wire s1_an_3_esd,
    inout wire s2_an_0_esd,
    inout wire s3_an_0_esd,
    inout wire s3_an_1_esd,
    inout wire s4_an_0_esd,
    inout wire s4_an_1_esd,
    inout wire s4_an_2_esd,
    inout wire s5_an_0_esd,
    inout wire s5_an_1_esd,
    inout wire s6_an_0_esd,
    inout wire s7_an_0_esd,
    inout wire s7_an_1_esd,
    inout wire s8_an_0_esd,
    inout wire s8_an_1_esd,
    inout wire s8_an_2_esd,
    inout wire s9_an_0_esd,
    inout wire s9_an_1_esd,
    inout wire s9_an_2_esd,
    inout wire s10_an_0_esd,
    inout wire s10_an_1_esd,
    inout wire s11_an_0_esd,
    inout wire s12_an_0_esd,
    inout wire s12_an_1_esd,
    inout wire s13_an_0_esd,
    inout wire s13_an_1_esd,
    inout wire s13_an_2_esd,
    inout wire s14_an_0_esd,
    inout wire s14_an_1_esd,
    inout wire s15_an_0_esd,
    inout wire s16_an_0_esd,
    inout wire s16_an_1_esd,
    inout wire s16_an_2_esd,
    inout wire s16_an_3_esd,
    ...
    sg13cmos5l_IOPadAnalog pad_s1_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s1_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s1_an_2 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s1_an_3 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s2_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s4_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s4_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s4_an_2 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s5_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s5_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s6_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s7_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s7_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s8_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s8_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s8_an_2 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s9_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s9_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s9_an_2 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s10_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s10_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s11_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s12_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s12_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s13_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s13_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s13_an_2 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s14_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s14_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s15_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s16_an_0 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s16_an_1 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s16_an_2 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
    ...
    sg13cmos5l_IOPadAnalog pad_s16_an_3 (
	`ifdef USE_POWER_PINS
	    .iovdd(vdd3v3),
	    .iovss(vss3v3),
	    .vdd(vdd1v2),
