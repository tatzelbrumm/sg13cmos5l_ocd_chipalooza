#!/bin/bash
#
# Open Circuit Design "Chipalooza" analog harness for IHP SG13CMOS5L
#
# Padframe generation
#
...
#
# Usage:
#	setenv PDK_ROOT <path/to/IHP/pdk/parent>
#	./run_gen_padframe.sh
#
...
#	   "sN_an" position, and use that as input to create the signals
