 ...
 * which can be divided 6 and 6, 8 and 4, 10 and 2, etc.
 *
...
module router(
    ...
    input wire [31:0] user_out_route 	// pin assignments
);
...
for (i = 0; i < 12; i = i + 1) begin : out_mux
    ...
    assign io_oe[i] = ((user_out_route[0] == i) ||
	...
	(user_out_route[11*4 +: 4] == i)) ? 1'b1 : 1'b0; 
...
for (i = 0; i < 16; i = i + 1) begin : in_mux1
	...
	(user_in_route[i*4 +: 4] == 4'hc) ? 1'b0 :
	(user_in_route[i*4 +: 4] == 4'hd) ? 1'b1 :
	(user_in_route[i*4 +: 4] == 4'he) ? seq_out[i] :
	1'b0;
end
...
for (i = 16; i < 24; i = i + 1) begin : in_mux2
	...
	(user_in_route[i*4 +: 4] == 4'hc) ? 1'b0 :
	(user_in_route[i*4 +: 4] == 4'hd) ? 1'b1 :
	(user_in_route[i*4 +: 4] == 4'he) ? sram_out[i - 16] :
	1'b0;
end
endgenerate
