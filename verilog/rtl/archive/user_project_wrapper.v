...
`endif
    ...
    inout wire [2:0] analog_pin, // project dedicated analog pins
    inout wire [1:0] analog_opt, // neighboring project pins*
    input wire [1:0] ibias, 	// shared current biases
    input wire	     vbias,	// shared voltage bias
  
    inout wire [2:0] analog_bus	// shared analog busses
);

// *NOTE:  The neighboring project pins can only be used with permission
//  in advance as they require that the neighboring projects use fewer
//  than the maximum alotment of dedicated analog pins.
