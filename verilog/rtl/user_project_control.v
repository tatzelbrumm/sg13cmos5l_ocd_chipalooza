...
module user_project_control (
    ...
    output wire [11:0] dig_out,		// 15 digital bit shared bus
...
assign dig_out = (select & dig_ena) ? proj_dig_out : 12'bz;

/* TO BE DONE: dig_ena should act as a latch---Use latches
 * (or can the synthesis tools infer a latch?)
 */
assign proj_dig_in = {24{select & dig_ena}} & dig_in;
